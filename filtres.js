...
function displayArticleRecipes(recipes) {
...
function recherchePrincipale(recipes) {
    ...
    inputSearch.addEventListener("input", () => {
        ...
        afficheArticleRecette.innerHTML = filtreRecipes.length ? '': '<p>Aucune recette ne correspond à votre recherche.</p>'
        if (filtreRecipes.length) {
            displayArticleRecipes(filtreRecipes)
